...
**Python Windows installation** See the step-by-step beginner guide: [docs/SETUP_WINDOWS.md](docs/SETUP_WINDOWS.md) (download from GitHub, install Python, run the site).
...
Open that URL in your browser. The API docs are at [http://127.0.0.1:8765/docs](http://127.0.0.1:8765/docs)
