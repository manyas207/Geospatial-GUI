...
**What you will end up with:** a local website at **http://127.0.0.1:8765/** that you open in Chrome, Edge, or Firefox.
...
2. Go to: **https://github.com/manyas207/Geospatial-GUI**
...
If you prefer updating the project with `git pull` in the future, you can install Git from https://git-scm.com/download/win and clone instead of using ZIP. For a first run, the ZIP method above is enough.
...
1. Open **https://api.census.gov/data/key_signup.html** in your browser.
...
**API documentation (when the server is running):** http://127.0.0.1:8765/docs
...
- [ ] Downloaded ZIP from https://github.com/manyas207/Geospatial-GUI and extracted it
...
- [ ] Opened http://127.0.0.1:8765/ in the browser
